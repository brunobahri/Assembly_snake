...
data segment
    ;mainmenu
    main1 db "Bruno Snake"
    main2 db "In this game you must eat 3 letters by sequence:"
    main3 db "First eat 'r' then 'u' then 'n' then 'o'"
    main4 db "Move the snake by pressing the keys w,a,s,d"
    main5 db "w:move up"
    main6 db "s:move down"
    main7 db "d:move right"
    main8 db "a:move left"
    about1 db "This game is done by: Bruno Bahri,"
    about2 db "Just Learning Assembly"
    main9 db "The snake head is the 'B' in the middle of the screen"
    ...
    snake db 'B',5 Dup(0) ;Collected letters array
